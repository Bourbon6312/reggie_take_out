...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Orders> implements OrderService {
    ...
    public void submit(Orders orders) {
        ...
        if (addressBook == null) throw new CustomException("地址有误！");
        ...
        List<OrderDetail> orderDetails = shoppingCarts.stream().map((item) -> {
            ...
            amount.addAndGet(item.getAmount().multiply(new BigDecimal(item.getNumber())).intValue()); //addAndGet相当于+=
            return orderDetail;
    ...
    public Page<OrdersDto> userPage(int page, int pageSize) {
        ...
        this.page(pageInfo, ordersQueryWrapper);
